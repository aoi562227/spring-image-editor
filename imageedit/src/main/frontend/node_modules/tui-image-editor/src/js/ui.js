...
class Ui {
  ...
  _makeUiElement(element) {
    ...
    selectedElement.innerHTML =
      controls({
        ...
        signUpButtonStyle: this.theme.getStyle('signUpButton'),
        loginButtonStyle: this.theme.getStyle('loginButton'),
        retrieveButtonStyle: this.theme.getStyle('retrieveButton'),
    ...
    this._buttonElements = {
      signUp: this._selectedElement.querySelectorAll('.tui-image-editor-signUp-btn'),
      login: this._selectedElement.querySelectorAll('.tui-image-editor-login-btn'),
      retrieve: this._selectedElement.querySelectorAll('.tui-image-editor-retrieve-btn'),
      upload: this._selectedElement.querySelectorAll('.tui-image-editor-upload-btn'),
   ...
   */
  _addSignUpEvent() {
    this.eventHandler.signUp = () => this._actions.main.signUp();
    forEach(this._buttonElements.signUp, (element) => {
      element.addEventListener('click', this.eventHandler.signUp);
    });
  }

  _removeSignUpEvent() {
    forEach(this._buttonElements.signUp, (element) => {
      element.removeEventListener('click', this.eventHandler.signUp);
    });
  }
   ...
   */
  _addLoginEvent() {
    this.eventHandler.login = () => this._actions.main.login();
    forEach(this._buttonElements.login, (element) => {
      element.addEventListener('click', this.eventHandler.login);
    });
  }

  _removeLoginEvent() {
    forEach(this._buttonElements.login, (element) => {
      element.removeEventListener('click', this.eventHandler.login);
    });
  }
   ...
   */
   _addRetrieveEvent() {
    this.eventHandler.retrieve = () => this._actions.main.retrieve();
    forEach(this._buttonElements.retrieve, (element) => {
      element.addEventListener('click', this.eventHandler.retrieve);
    });
  }

  _removeRetrieveEvent() {
    forEach(this._buttonElements.retrieve, (element) => {
      element.removeEventListener('click', this.eventHandler.retrieve);
    });
  }
   ...
   */
   _addUploadEvent() {
    this.eventHandler.upload = () => this._actions.main.upload();
    forEach(this._buttonElements.upload, (element) => {
      element.addEventListener('click', this.eventHandler.upload);
    });
  }

  _removeUploadEvent() {
    forEach(this._buttonElements.upload, (element) => {
      element.removeEventListener('click', this.eventHandler.upload);
    });
  }
  ...
  activeMenuEvent() {
    ...
    this._addSignUpEvent();
    this._addLoginEvent();
    this._addRetrieveEvent();
  ...
  _removeUiEvent() {
    ...
    this._removeSignUpEvent();
    this._removeLoginEvent();
    this._removeRetrieveEvent();
    this._removeUploadEvent();
